...
module.exports = {
  ...
  "RECAPTCHA_PRIV_KEY": process.env.RECAPTCHA_PRIV_KEY || '6LcI4TUUAAAAAClk_88j7JCTZVPfCso8nfkQ4n07',
  "RECAPTCHA_SITE_KEY": process.env.RECAPTCHA_SITE_KEY || '6LcI4TUUAAAAAKCmTL_ExEltAdf18SgE4VM2uils',
